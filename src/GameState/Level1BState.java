...
public class Level1BState extends LevelState {
	...
	public Level1BState(GameStateManager gsm, Player p1, Player p2) {
		super(gsm);
		player = p1;
		player2 = p2;
		init();
...
///////////////////////////////////////////////////////
	...
	private void eventFinish() {
		...
		if(eventCount == 180) {
			gsm.setLevelState(GameStateManager.LEVEL1CSTATE, player, player2);
		}
